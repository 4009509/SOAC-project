...
ax = plt.gca()
ax.set_facecolor('darkgrey')
plt.plot(luminosities[:int(len(luminosities) / 2)], growth_white[:int(len(luminosities)/2)], color = 'white', label = 'White daisies (increasing L)')
plt.plot(luminosities[int(len(luminosities) / 2):], growth_white[int(len(luminosities) / 2):], color = 'white', linestyle = 'dashed', label = 'White daisies (decreasing L)')
#plt.plot(luminosities[:int(len(luminosities) / 2)], growth_black[:int(len(luminosities)/2)], color = 'black', label = 'Black daisies (increasing L)')
#plt.plot(luminosities[int(len(luminosities) / 2):], growth_black[int(len(luminosities) / 2):], color = 'black', linestyle = 'dashed', label = 'Black daisies (decreasing L)')
